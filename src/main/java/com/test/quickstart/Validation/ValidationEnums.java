...
public class ValidationEnums {
	...
	{
		VERSION, ENDPOINT_MODE, DEPLOY_MODE, RESTART_POLICY_CONDITION, RBFAILUREACTION, UCFAILUREACTION, CONFIGORDER, BOOLEAN, ISOLATION, HEALTHCHECK, NETWORK_MODE
	}
	public enum CheckStringType
	{
		IMAGE, MEMORY, INTEGER, TIME, DNS, DOMAIN, IPV6
	}

...
public class ValidationEnums {
	...
	public enum ContainsStringType
	{
		...
		UCFAILUREACTION, CONFIGORDER, BOOLEAN, ISOLATION, HEALTHCHECK, NETWORK_MODE, PID, PORT_PROTOCOL, PORT_MODE, VOLUME_TYPE, VOLUME_CONSISTENCY
	}
	public enum CheckStringType
	{
		IMAGE, MEMORY, INTEGER, TIME, DNS, DOMAIN, IPV6, PORT, MAC, UNIX_PERM
	}

...
public class ParsingTests {
	...
	public void testFullCompose() 
	{
		...
		args.put("buildno", "1");
		assertEquals(level.getServices().get("webapp").getBuildB().getArgsM(), args);
		...
		assertEquals(level.getServices().get("webapp").getDeploy().getRollback_config().getOrder(), "pause");
		...
		Map<String,String> argsB = new HashMap<>();;
		argsB.put("buildno", "1");
		assertEquals(level.getBuildB().getArgsM(), argsB);
		...
		assertEquals(level.getDns_search(), "example.com");
		...
		assertEquals(level.getIpc(), "mhost");
